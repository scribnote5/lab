...
@Repository
@Transactional
public class IntroductionImageAttachedFileRepositoryImpl extends QuerydslRepositorySupport {
    private final JPAQueryFactory queryFactory;

    public IntroductionImageAttachedFileRepositoryImpl(JPAQueryFactory queryFactory) {
